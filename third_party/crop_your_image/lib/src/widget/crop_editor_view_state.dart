...
class ReadyCropEditorViewState extends CropEditorViewState {
  ...
  late final baseImageRect = isFitVertically
      ? Size(
  ...
  late final minimumScale = max(
    cropRect.width / baseImageRect.width,
    cropRect.height / baseImageRect.height,
  );
  ...
  ReadyCropEditorViewState scaleUpdated(
    ...
    // clamp the scale
    nextScale = max(nextScale, minimumScale);
    ...
    // width
    final newWidth = baseImageRect.width * nextScale;
    ...
    // height
    final newHeight = baseImageRect.height * nextScale;
